...
MODEL = dict(
    ...
    horizontal_eddy_viscosity_m2s=10.0,  # constant Ah on the 50/90 m regional grids
    ...
    cfl_number=0.85,                 # Courant safety factor for the explicit step
    min_timestep_s=0.4,              # floor on the CFL-limited step (never binds here)
    spin_up_cycles=1.0,
    sim_cycles=1.5,
